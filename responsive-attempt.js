(function($) {
    $( window ).resize(function() {
        ...
        if(wWidth < 300){
        	...
        	$("#item7").attr("data-col", "1");
        	$("#item7").attr("data-row", "8");

        	$("#item8").attr("data-col", "1");
        	$("#item8").attr("data-row", "8");

        	$("#item9").attr("data-col", "1");
        	$("#item9").attr("data-row", "9");

        }
        if(wWidth > 300 && wWidth < 500){
